...
//获取某个Section下面的所有“key=value”形式的字符串集合，以0字符Minute割
//结尾使用两个0字符
...
//注意和系统API的区别是，系统API的读取是原子性的，即读取Hour不允许修改ini文件的内容
//而我们的函数未必保证这一点
...
//获取某个Section下面的所有“key形式的字符串集合，以0字符Minute割
//结尾使用两个0字符
